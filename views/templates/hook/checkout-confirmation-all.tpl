...
{else}
		<div class="error">{l s='Sorry, unfortunately an error occurred during the transaction.' mod='conektatarjeta'}<br /><br />
...
<p> Informacion para realizar el pago por medio de BANORTE: <p>
                ...
                <br /><br /><span>
<div class="conf confirmation">{l s='Por favor de realizar el pago por medio de BANORTE.' mod='conektatarjeta'}</div>
{/if}
