...
<p> {l s='Informacion para realizar el pago:' mod='conekta'} <p>
                ...
                <br><b><p>La tienda cobrará una comisión adicional al momento de realizar el pago</p>
                <br><h1>Referencia: {$conekta_order.barcode|escape:'htmlall':'UTF-8'}</h1>
                <br><h4>Instrucciones</h3>
                <br><p>1.- Acude a la tienda  más cercana</p>
                <br><p>2.- Indica en caja que quieres realizar un pago con conekta efectivo</p>
                ...
                <br /><br /><span>
<div class="conf confirmation">{l s='Por favor de imprimir la ficha de pago y realizar el pago en la tienda más cercana.' mod='conekta'}</div>
{/if}
